    ...
    public static class GlobalVariables
    {
        ...
        public static void InitVars(string host,HttpContext context)
        {
            using (Dist23Data db = new Dist23Data())
            {
                ...
                if(sc == null)
                    sc = db.SiteConfig.FirstOrDefault(x => x.DistKey == 11);
        ...
        {
            if (context.Request != null && context.Request.ServerVariables["HTTP_USER_AGENT"] != null)
            {
                var u = context.Request.ServerVariables["HTTP_USER_AGENT"].ToString();
